...
class VehicleFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'color' => fake()->randomElement(['Blanco perla', 'Gris Oxford', 'Negro Ónix', 'Plata metálico']),
            'capacity' => fake()->randomElement([4, 4, 4, 7]),
            ...
            'location_zone' => 'Corredor '.fake()->word(),
            'location_lat' => fake()->latitude(19.2, 19.6),
            'location_lng' => fake()->longitude(-99.4, -98.9),
